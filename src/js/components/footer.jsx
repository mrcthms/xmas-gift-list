...
import FooterActions from '../actions/footer-actions.jsx';
...
class Footer extends React.Component {
  ...
  render() {
    var leaderboardCharacters = typeof this.state.characters !== "string" ? this.state.characters.map((character) => {
      return (
        <li key={character.characterId}>
          <Link to={'/characters/' + character.characterId}>
            <img src={'http://image.eveonline.com/Character/' + character.characterId + '_128.jpg'} />
          </Link>
        </li>
      );
    }) : [];
